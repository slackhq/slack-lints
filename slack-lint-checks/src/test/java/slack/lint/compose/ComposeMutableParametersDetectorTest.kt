...
class ComposeMutableParametersDetectorTest : BaseSlackLintTest() {
  ...
  fun `errors when a Composable has a mutable parameter`() {
    ...
    lint()
      ...
      .expect(
        """
          src/test.kt:2: Error: Using mutable objects as state in Compose will cause your users to see incorrect or stale data in your app. [ComposeModifierMissing]
          fun Something(a: MutableState<String>) {}
              ~~~~~~~~~
          src/test.kt:4: Error: Using mutable objects as state in Compose will cause your users to see incorrect or stale data in your app. [ComposeModifierMissing]
          fun Something(a: ArrayList<String>) {}
              ~~~~~~~~~
          src/test.kt:6: Error: Using mutable objects as state in Compose will cause your users to see incorrect or stale data in your app. [ComposeModifierMissing]
          fun Something(a: HashSet<String>) {}
              ~~~~~~~~~
          src/test.kt:8: Error: Using mutable objects as state in Compose will cause your users to see incorrect or stale data in your app. [ComposeModifierMissing]
          fun Something(a: MutableMap<String, String>) {}
              ~~~~~~~~~
          4 errors, 0 warnings
        """
