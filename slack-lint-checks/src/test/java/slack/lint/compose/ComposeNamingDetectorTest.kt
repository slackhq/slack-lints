...
class ComposeNamingDetectorTest : BaseSlackLintTest() {
  ...
  fun `errors when a composable returns a value and is capitalized`() {
    ...
    lint()
      ...
      .expect(
        """
          src/test.kt:2: Error: Composable functions that return a value should start with a lowercase letter. [ComposeNaming]
          fun MyComposable(): Something { }
              ~~~~~~~~~~~~
          1 errors, 0 warnings
        """
  ...
  fun `errors when a composable returns nothing or Unit and is lowercase`() {
    ...
    lint()
      ...
      .expect(
        """
          src/test.kt:2: Error: Composable functions that return Unit should start with an uppercase letter. [ComposeNaming]
          fun myComposable() { }
              ~~~~~~~~~~~~
          src/test.kt:5: Error: Composable functions that return Unit should start with an uppercase letter. [ComposeNaming]
          fun myComposable(): Unit { }
              ~~~~~~~~~~~~
          2 errors, 0 warnings
        """
