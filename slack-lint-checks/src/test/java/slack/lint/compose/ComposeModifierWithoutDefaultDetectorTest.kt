...
class ComposeModifierWithoutDefaultDetectorTest : BaseSlackLintTest() {
  ...
  fun `errors when a Composable has modifiers but without default values`() {
    ...
    lint()
      ...
      .expect(
        """
          src/test.kt:2: Error: This @Composable function has a modifier parameter but it doesn't have a default value. [ComposeModifierWithoutDefault]
          fun Something(modifier: Modifier) { }
                        ~~~~~~~~~~~~~~~~~~
          src/test.kt:4: Error: This @Composable function has a modifier parameter but it doesn't have a default value. [ComposeModifierWithoutDefault]
          fun Something(modifier: Modifier = Modifier, modifier2: Modifier) { }
                                                       ~~~~~~~~~~~~~~~~~~~
          2 errors, 0 warnings
        """
