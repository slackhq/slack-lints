...
class ComposeModifierMissingDetectorTest : BaseSlackLintTest() {
  ...
  fun `errors when a Composable has a layout inside and it doesn't have a modifier`() {
    ...
    lint()
      ...
      .expect(
        """
          src/test.kt:2: Error: This @Composable function emits content but doesn't have a modifier parameter. [ComposeModifierMissing]
          fun Something1() {
              ~~~~~~~~~~
          src/test.kt:7: Error: This @Composable function emits content but doesn't have a modifier parameter. [ComposeModifierMissing]
          fun Something2() {
              ~~~~~~~~~~
          src/test.kt:12: Error: This @Composable function emits content but doesn't have a modifier parameter. [ComposeModifierMissing]
          fun Something3(): Unit {
              ~~~~~~~~~~
          3 errors, 0 warnings
        """
